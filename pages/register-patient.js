...
class RegisterPatient extends Component {
  ...
  onSubmit = async (event) => {
    ...
    this.setState({
        // ... (resetting other state properties)
        showIc: true, // Reset showIc to true after submission
      });

  };

  handleToggleIc = () => {
    this.setState((prevState) => ({ showIc: !prevState.showIc }));
  };
